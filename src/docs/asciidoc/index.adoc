...
[.cue]
****
Bonjour à tous, j'espère que votre Breizhcamp se passe bien.
...
Peut être que ca vous donnera, du coup, des idées de réalisation pour chez vous, pas besoin d'attendre mardi (et vous êtes décideur, peut-être…).
****
...
Et si je ne parle pas de choses super intéressantes, c'est juste que je ne les utilise pas, donc je suis preneur pour pouvoir les rajouter à mon installation :)
****
...
[role="image_slide upper left"]
image::connected_plug.png[]

[role="image_slide lower right"]
image::door_sensor.png[]

[role="image_slide lower left"]
image::motion_sensor.png[]

[role="image_slide upper right"]
image::smoke_sensor.png[]
...
L'idée est juste de push un tag vide sur le repo, et le hook se charge d'injecter la variable d'env nécessaire.
****
